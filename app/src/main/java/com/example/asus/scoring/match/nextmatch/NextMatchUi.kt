...
class NextMatchUi:AnkoComponent<NextMatch>,MatchView{
    ...
    override fun createView(ui: AnkoContext<NextMatch>): View =  with(ui){
      linearLayout {
          ...
          val gson = Gson()
          presenter = NextMatchPresenter(this@NextMatchUi, request, gson)
          presenter.getNextEvent(BuildConfig.LEAGUE_ID)
