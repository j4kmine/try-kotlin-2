...
import com.example.asus.scoring.match.pastmatch.PastMathcPresenter
...
class PastMatchPresenterTest{
    ...
    fun setUp() {
        ...
        presenter = PastMathcPresenter(view, apiRepository, gson, TestContextProvider())
    }
